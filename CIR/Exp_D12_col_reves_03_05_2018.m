function Exp_D12_col_reves_03_05_2018()
...
[data_matrix, text_data, alldata] = xlsread(...
    'D12_180502_145150_EtOH_CO2_175bar_40ºC_coluna3.xlsx',2); 
...
Resultados_CIR_fitt.u0_exp = u0_exp; % (cm/s) velocidade linear dentro da coluna - calculadas a partir das condiçoes operatorias da bomba
...
Resultados_CIR_fitt.k_optim = k_optim_CIR_1; % coeficiente de retenção 
...
figure(5)
plot(time_integral_final,Absor_norm_exp_i,'x', time_integral_final,Absor_norm_exp)
